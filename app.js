class Board {
    ...
    /**   // ДОМАШНЕЕ ЗАДАНИЕ
     * Метод показывает текущий счет.  
     */
    displayScore() {

        if (this.snake.body.length > this.currentScore.innerHTML) {
            this.currentScore.innerHTML = this.snake.body.length
        }
    }
    ...
    isNextStepToBody(nextCellCoords) { //ДОмашнее задание
...
class Game {
    ...
    doTick() {
        ...
        this.board.displayScore(); // ДОМАШНЕЕ ЗАДАНИЕ
    }
