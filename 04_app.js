...
function showMoreText(card) {
    ...
    const randText ='Lorem ipsum dolor sit amet, consectetur adipisicing elit.'
    // 6.2 внутри .product есть .productName, после него вставляем div.desc и текстом из переменной из п. 6.1
    card.productName.insertAdjacentHTML('afterend', `<div class = "desc">${randText}</div>`);
