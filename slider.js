// КОД ДЛЯ СЛАЙДЕРА. ДОБАВЛЕННЫЙ КОД ИСЧЕЗАНИЯ ФОТОГРАФИЙ НАЧИНАЕТСЯ СО СТРОК 93 и 125.
...
let images = {
    ...
    setNextLeftImage() {
		...
		oldSlide.classList.add('fade-out-left');
		
		
		setTimeout(()=>{
			oldSlide.classList.add('hidden-slide');
			oldSlide.classList.remove('fade-out-left');
		},500);
		...
		setTimeout(()=>{
        	newSlide.classList.add('slider-rightToLeftAnimation');
			newSlide.classList.remove('hidden-slide');
		},300);
		
        setTimeout(()=>{
            newSlide.classList.remove('slider-rightToLeftAnimation');
        },1000);
    ...
    setNextRightImage() {
		...
		const oldSlide = this.slides[this.currentIdx];
		oldSlide.classList.add('fade-out-right');
		
		
		setTimeout(()=>{
			oldSlide.classList.add('hidden-slide');
			oldSlide.classList.remove('fade-out-right');
		},500);
		...
		setTimeout(()=>{
        	newSlide.classList.add('slider-leftToRightAnimation');
			newSlide.classList.remove('hidden-slide');
		},300);
		
        setTimeout(()=>{
            newSlide.classList.remove('slider-leftToRightAnimation');
        },1000);
